...
public class ModEntities {
    ...
    public static void registerAttributes() {
        ...
        net.minecraft.entity.SpawnRestriction.register(
                WILD_BOAR,
                net.minecraft.entity.SpawnLocationTypes.ON_GROUND,
                net.minecraft.world.Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
                net.minecraft.entity.passive.AnimalEntity::isValidNaturalSpawn
        );
        net.minecraft.entity.SpawnRestriction.register(
                DEER,
                net.minecraft.entity.SpawnLocationTypes.ON_GROUND,
        ...
        net.minecraft.entity.SpawnRestriction.register(
                ...
                net.minecraft.entity.SpawnLocationTypes.ON_GROUND,
                net.minecraft.world.Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
                net.minecraft.entity.mob.MobEntity::canMobSpawn
        );
        net.minecraft.entity.SpawnRestriction.register(
                RIDEABLE_BOAR,
                net.minecraft.entity.SpawnLocationTypes.ON_GROUND,
